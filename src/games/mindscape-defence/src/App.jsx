...
function GameRunner() {
  ...
  const getBackgroundImage = (lvl) => {
    switch(lvl) {
      case 1: return "url('/1.png')";
      case 2: return "url('/2.png')";
      case 3: return "url('/3.png')";
      case 4: return "url('/4.png')";
      case 5: return "url('/5.png')";
      case 6: return "url('/6.png')";
      default: return "url('/1.png')";
    }
  };
